            ...
            <div className="grid lg:grid-cols-2 gap-12 sm:gap-16">
                ...
                <div className="space-y-6 sm:space-y-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {[
                        { name: 'GitHub', handle: '@matthewseymour', url: 'https://github.com/MatthewSeymour1' },
                        { name: 'IADT', handle: '@matthewseymour', url: '#' },
                        { name: 'HubSpot Community', handle: '@matthewseymour', url: '#' },
                        { name: 'LinkedIn', handle: 'matthewseymour', url: 'https://www.linkedin.com/in/matthew-seymour-414239396/' },
                        ].map((social) => (
                        <a
                            key={social.name}
                            href={social.url}
